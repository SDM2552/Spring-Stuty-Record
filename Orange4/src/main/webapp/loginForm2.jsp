...
%>
    ...
    <button class="btn btn-primary w-100 py-2" type="button" onclick="window.location.href='memberJoinForm2.jsp';">회원 가입</button>
    <button class="btn btn-primary w-100 py-2 lastbtn" type="button" onclick="window.location.href='index2.jsp';">메인으로</button>
    <p class="mt-5 mb-3 text-body-secondary">&copy; 2024-2024 Orange Company</p>
  </form>
</main>
