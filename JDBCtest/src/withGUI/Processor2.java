...
public class Processor2 {
	...
	public Processor2(Statement stmt, Connection conn, JTextArea ta, JTextField tf1, JTextField tf2, JTextField tf3,
...
//========================== 데이터 수정 ========================================
public void update() {
    String sql = "UPDATE emp SET empno=" + tf1.getText() + ", ename='" + tf2.getText() + "', job='" + tf3.getText() + "', mgr=" + tf4.getText() + ", hiredate='" + tf5.getText() + "', sal=" + tf6.getText() + ", comm=" + tf7.getText() + ", deptno=" + tf8.getText() + " WHERE empno=" + empno;
	    try {
	    	ta.setText("");
